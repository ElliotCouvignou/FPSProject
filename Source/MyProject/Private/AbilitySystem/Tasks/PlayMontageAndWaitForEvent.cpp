...
#include "AbilitySystem/Tasks/PlayMontageAndWaitForEvent.h"
...
UFPSAbilitySystemComponent* UPlayMontageAndWaitForEvent::GetTargetASC()
{
...
void UPlayMontageAndWaitForEvent::Activate()
{
	...
	if (GSAbilitySystemComponent)
	{
		...
		if (AnimInstance != nullptr)
		{
			...
			EventHandle = GSAbilitySystemComponent->AddGameplayEventTagContainerDelegate(EventTags, FGameplayEventTagMulticastDelegate::FDelegate::CreateUObject(this, &UPlayMontageAndWaitForEvent::OnGameplayEvent));
