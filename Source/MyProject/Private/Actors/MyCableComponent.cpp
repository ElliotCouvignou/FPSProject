...
//
//
// #include "Actors/MyCableComponent.h"
...
// 	}
//
// 	FCableSceneProxy(UMyCableComponent* Component)
...
// }
//
// FPrimitiveSceneProxy* UMyCableComponent::CreateSceneProxy()
// {
// 	return new FCableSceneProxy(this);
// }
//
// int32 UMyCableComponent::GetNumMaterials() const
// {
// 	return 1;
// }
//
// void UMyCableComponent::OnRegister()
// {
// 	Super::OnRegister();
//
...
// 	{
// 		FMYCableParticle& Particle = Particles[ParticleIdx];
//
...
// }
//
// void UMyCableComponent::VerletIntegrate(float InSubstepTime, const FVector& Gravity)
// {
...
// static FORCEINLINE void SolveDistanceConstraint(FMYCableParticle& ParticleA, FMYCableParticle& ParticleB, float DesiredDistance)
// {
...
// }
//
// void UMyCableComponent::SolveConstraints()
// {
...
// 		{
// 			FMYCableParticle& ParticleA = Particles[SegIdx];
// 			FMYCableParticle& ParticleB = Particles[SegIdx + 1];
...
// 			{
// 				FMYCableParticle& ParticleA = Particles[SegIdx];
// 				FMYCableParticle& ParticleB = Particles[SegIdx + 2];
...
// }
//
// void UMyCableComponent::PerformCableCollision()
// {
...
// }
//
// void UMyCableComponent::PerformSubstep(float InSubstepTime, const FVector& Gravity)
// {
...
// }
//
// void UMyCableComponent::SetAttachEndToComponent(USceneComponent* Component, FName SocketName)
// {
...
// }
//
// void UMyCableComponent::SetAttachEndTo(AActor* Actor, FName ComponentProperty, FName SocketName)
// {
...
// }
//
// AActor* UMyCableComponent::GetAttachedActor() const
// {
// 	return AttachEndTo.OtherActor;
// }
//
// USceneComponent* UMyCableComponent::GetAttachedComponent() const
// {
// 	return Cast<USceneComponent>(AttachEndTo.GetComponent(GetOwner()));
// }
//
// void UMyCableComponent::GetCableParticleLocations(TArray<FVector>& Locations) const
// {
// 	Locations.Empty();
// 	for (const FMYCableParticle& Particle : Particles)
// 	{
...
//
//
// void UMyCableComponent::GetEndPositions(FVector& OutStartPosition, FVector& OutEndPosition)
// {
...
// }
//
// void UMyCableComponent::OnVisibilityChanged()
// {
...
// }
//
// void UMyCableComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction *ThisTickFunction)
// {
...
// 	GetEndPositions(CableStart, CableEnd);
//
// 	FMYCableParticle& StartParticle = Particles[0];
//
// 	if (bAttachStart)
// 	{
...
// 	}
//
// 	FMYCableParticle& EndParticle = Particles[NumSegments];
// 	if (bAttachEnd)
// 	{
...
// };
//
// void UMyCableComponent::CreateRenderState_Concurrent(FRegisterComponentContext* Context)
// {
...
// }
//
// void UMyCableComponent::ApplyWorldOffset(const FVector & InOffset, bool bWorldShift)
// {
// 	Super::ApplyWorldOffset(InOffset, bWorldShift);
//
// 	for (FMYCableParticle& Particle : Particles)
// 	{
...
// }
//
// void UMyCableComponent::SendRenderDynamicData_Concurrent()
// {
// 	if(SceneProxy)
// 	{
...
// }
//
// FBoxSphereBounds UMyCableComponent::CalcBounds(const FTransform& LocalToWorld) const
// {
...
// 	for(int32 ParticleIdx=0; ParticleIdx<Particles.Num(); ParticleIdx++)
// 	{
// 		const FMYCableParticle& Particle = Particles[ParticleIdx];
...
// }
//
// void UMyCableComponent::QuerySupportedSockets(TArray<FComponentSocketDescription>& OutSockets) const 
// {
...
// }
//
// FTransform UMyCableComponent::GetSocketTransform(FName InSocketName, ERelativeTransformSpace TransformSpace) const
// {
...
// }
//
// bool UMyCableComponent::HasAnySockets() const
// {
// 	return (Particles.Num() >= 2);
// }
//
// bool UMyCableComponent::DoesSocketExist(FName InSocketName) const
// {
