...
#include "PlayMontageForMeshAndWaitEvent.generated.h"
 ...
 */
UCLASS()
class MYPROJECT_API UPlayMontageForMeshAndWaitEvent : public UAbilityTask
{
	GENERATED_BODY()

public:

	UPlayMontageForMeshAndWaitEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	static UPlayMontageForMeshAndWaitEvent* PlayMontageForMeshAndWaitForEvent(
...
private:
	...
	UFPSAbilitySystemComponent* GetTargetASC();
